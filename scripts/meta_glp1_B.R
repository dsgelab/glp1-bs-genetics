...
# Read in results for GLP1 - model B
for (f in files){
...
fwrite(res_tot, "/Users/germanja/Documents/glp1-weight-loss-jg/results/wq/meta_GLP1_B_20240424.tsv", sep = "\t")
fwrite(meta_het, "/Users/germanja/Documents/glp1-weight-loss-jg/results/wq/meta_GLP1_B_20240424_ancestry_het.tsv", sep = "\t")
