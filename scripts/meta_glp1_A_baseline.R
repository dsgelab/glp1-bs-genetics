...
for (e in unique(meta_results_anc_wide$Exposure)) {
  ...
  for (v in c("exposure", "baseline_body_weight_in_kg", "sex", "age_at_initiation_in_years")){
    ...
    if (v == "age_at_initiation_in_years" ){
      h <- data.frame(
        Exposure = e,
        Q_het = m$Q,
        P_Q_het = m$pval.Q,
...
#fwrite(res_tot, "/Users/germanja/Documents/glp1-weight-loss-jg/results/meta_GLP1_A_20240424.tsv", sep = "\t")
#fwrite(meta_het, "/Users/germanja/Documents/glp1-weight-loss-jg/results/meta_GLP1_A_20240424_ancestry_het.tsv", sep = "\t")
